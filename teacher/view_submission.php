  ...
  <section class="content">
    <div class="card">
      ...
      <div class="mt-3">
        ...
        <?php endif; ?>
        <button type="button" class="btn btn-success" onclick="printSubmission()">Print</button>
    ...
    <html>
      <head>
        ...
        <style>
          ...
          h1, h4 { font-weight: 500; margin-bottom: 16px; }
          .mui-table {
            width: 100%;
            border-collapse: collapse;
            margin-bottom: 16px;
          ...
          .row-colored:nth-child(odd) { background: #f9f9f9; }
          h4 { margin-top: 24px; }
        </style>
      </head>

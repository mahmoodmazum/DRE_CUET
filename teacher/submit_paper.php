...
<div class="form-container">
  ...
  <form id="submissionForm" method="post" action="add_submission.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <small>(Please indicate the title of project; the title should be short and concise)</small>
    ...
    <div class="form-group">
      ...
      <small>(Please indicate the name and the department/organization).</small>
    ...
    <div class="form-group">
      ...
      <small>(Please provide a maximum of 5 key words that describe the research of the project).</small>
    ...
    <div class="form-group">
      ...
      <small>(Please describe the measurable objectives of the project and define the expected results. Use results-oriented wording with verbs such as “to define ...” to determine….”to identify …...)</small>
    ...
    <?php
    $areas = [
      'beneficiaries'=>'7. Direct Customers/Beneficiaries of the Project<small> (please identify clearly the potential customers/beneficiaries of the research results and provide details of their relevance, e.g. size economic contribution, etc.)</small>',
      'outputs'=>'8. Outputs Expected from the Project<small>(please give details)</small>',
      'transfer'=>'9. Technology Transfer/Diffusion Approach<small>(please describe how the outputs of the project will be transferred to the direct beneficiaries/customers. Please also state if the project outputs are sustainable, i.e. if they can be utilized without further external assistance)</small>',
      'organizational_outcomes'=>'10. Organizational Outcomes Expected<small>(please give details)</small>',
      'national_impacts'=>'11. National Impacts Expected<small>(please give details)</small>',
      'external_org'=>'12. Outside Research Organizations/Industries Involved<small>(please identify all research organizations collaborating in the project and describe their role/contribution to the project)</small>',
    ];
